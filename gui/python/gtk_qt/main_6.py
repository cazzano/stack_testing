    ...
    def update_windows(self):
        ...
        for window in windows:
            ...
            if hasattr(item, 'setData'):
                self.window_list.item(self.window_list.count() - 1).setData(Qt.UserRole, address)
...
class HyprlandDemoApp(QMainWindow):
    ...
    def init_ui(self):
        self.setWindowTitle("Hyprland Qt5 Demo")
...
def main():
    ...
    app.setApplicationName("Hyprland Qt5 Demo")
